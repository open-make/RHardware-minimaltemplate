...
Because we expect most project to see this template when already having a prototype, we added a special chapter on starting at this stage (@sec-when-starting-the-documentation).
