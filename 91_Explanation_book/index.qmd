...
This book presents explanations for elements of the hardware project documentation template.
...
Because we expect most project to see this template when already having a prototype, we added a special chapter on starting at this stage (\@sec-whenstartingdocumentations).

Note_1: hardware development per se starts only in step four, the preparatisec-whenstartingdocumentationon phase is important if one does not want to end up reinventing the wheel or producing useless hardware.
