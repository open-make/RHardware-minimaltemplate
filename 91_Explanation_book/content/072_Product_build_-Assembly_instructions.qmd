## Product build -Assembly instructions {#sec-product-build--assembly-instructions}
...
<summary>Click to see the example!`<`{=html}
`/summary>`{=html}
...
\#### 2.
List of the tools for assembly or disassembly \* Mondatory \* ...
\* Optional \* ...
#### 3.
Assembly sequences \* Part list (refer to [Bill of Material (BOM)](https://github.com/OPEN-NEXT/WP2.3-Guideline-and-templatefor-documentation-of-OSH-design-reuse/tree/main/Documentation/4.%20Manufacturing#1-bill-of-material-bom)) \* Datasheet
