## User analysis - External interfaces (how will the product be used) {#sec-user-analysis-external-interfaces}

External interfaces are interactions between the product and the actors (including target users).
