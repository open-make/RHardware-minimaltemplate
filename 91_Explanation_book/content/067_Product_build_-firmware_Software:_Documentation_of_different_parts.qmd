# Product build -firmware/Software

Here comes the elements that were more briefly described in @sec-software-and-firmware-architecture. Since software/firmware development follows different practices that often needs a more detailed version control system, they are usually developed independently of the hardware.
