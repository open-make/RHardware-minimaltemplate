...
This section will give an overview of the structural model, while details are given in the specific mechanical (also called architectural, ), electrical () and software () architectures sections.
